...
urlpatterns = [
    ...
    # count down
    path('countdown', views.countdown_view, name="adminViewTimeCounter"),
    path('countdown/view', views.view_counter_by_id, name="viewCounter"),
    path('countdown/delete', views.deleteCounter, name='deleteCounter'),
    path('countdown/update', views.updateCounter, name="updateCounter"),
    path('gcsv', views.psg_voterlist, name="converttocsv"),
    path('gcsvcounter', views.psg_counter, name="converttocsvcounter"),
